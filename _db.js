...
let games = [
  { id: '1', title: 'Tetris, Running Bricks', platform: ['Windows'] },
  { id: '2', title: 'Pepaye, Flower teaser', platform: ['PS7', 'Xbox'] },
  { id: '3', title: 'Pinball Macrom', platform: ['Switc', 'PC', 'Xbox'] },
  { id: '4', title: 'Crown prince of Bellair', platform: ['Linux'] },
  {
    id: '5',
    title: 'Abdullah Thief of Bagdad',
    platform: ['PS7', 'Xbox', 'Mac'],
  },
]
